import 'package:cinemax/app/modules/login/controllers/login_controller.dart';
...
class LOGCustomPassFieldWidget extends GetView<LoginController> {
  const LOGCustomPassFieldWidget({
    Key? key,
    required this.label,
